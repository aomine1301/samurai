...
let initialState = {
    ...
    large:'https://picjumbo.com/wp-content/uploads/alone-with-his-thoughts-1080x720.jpg',
    small:'https://picjumbo.com/wp-content/uploads/alone-with-his-thoughts-1080x720.jpg'
}
...
export const updatePhotoThunk = (image)=> async (dispatch)=>{
    ...
    if (response.data.resultCode === 0) {
        ...
        response.data.large = initialState.image
        response.data.small = initialState.small
